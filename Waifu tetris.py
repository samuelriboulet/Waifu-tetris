...
while not done:
    ...
    text_echap= font1.render("Appuyez sur echap", True, (255, 215, 0))
    text_win = font1.render('Gagné!', True, (255, 200, 0))
    text_lose = font1.render('Perdu!', True, (255, 200, 0))
    screen.blit(waifu, [325,60])
    ...
    if game.score == 1:
        ...
        screen.blit(waifu, [325,60])
        screen.blit(text_win, [20,200])
        screen.blit(text_echap, [20,265])
        game.state = "gameover"
    elif game.state == "gameover":
        screen.blit(text_lose, [20,200])
        screen.blit(text_echap, [25, 265])
